...
import com.chao.baselib.skin.config.SkinConfig;
import com.chao.baselib.skin.entity.AttrFactory;
import com.chao.baselib.skin.entity.DynamicAttr;
import com.chao.baselib.skin.entity.SkinAttr;
import com.chao.baselib.skin.entity.SkinItem;
...
public class V4SkinInflaterFactory implements LayoutInflaterFactory {
    ...
    public V4SkinInflaterFactory() {
    }

    public V4SkinInflaterFactory(LayoutInflater inflater) {
    ...
    public View onCreateView(View parent, String name, Context context, AttributeSet attrs) {
        ...
        boolean isSkinEnable = attrs.getAttributeBooleanValue(SkinConfig.SPACENAME, SkinConfig.ATTR_SKIN_ENABLE, false);
        if (!isSkinEnable) {
            return null;
        }
