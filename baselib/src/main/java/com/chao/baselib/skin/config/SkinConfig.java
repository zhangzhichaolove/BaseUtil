package com.chao.baselib.skin.config;

import android.content.Context;

import com.chao.baselib.skin.util.PreferencesUtils;


public class SkinConfig {
    public static final String NAMESPACE = "http://schemas.android.com/android/skin";
    public static final String SPACENAME = "http://schemas.android.com/apk/res-auto";
